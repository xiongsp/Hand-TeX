...
from handtex.ui_generated_files.ui_IssueReporter import Ui_IssueReporter
...
class IssueReporter(Qw.QDialog, Ui_IssueReporter):
    ...
    def __init__(
        ...
        self.label_name_hidden.setText(
            'Note: Name "{name}" was hidden'.format(name=lp.get_username())
        )
    ...
    def open_issues() -> None:
        ...
        Qg.QDesktopServices.openUrl(Qc.QUrl("https://github.com/VoxelCubes/Hand-TeX/issues"))
